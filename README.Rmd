...
Status page adapted from [Garrick Aden-Buie](https://github.com/gadenbuie/status). Last update: `r strftime(Sys.time(), "%F %T %Z")`
...
repo_list <- params$repos
owner <- params$all_by_owner
